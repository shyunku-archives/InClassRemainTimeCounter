...
public class Global {
	...
	public static final Rectangle DRAGGABLE_AREA = new Rectangle(DEFAULT_TILE_SIZE, 0, EXIT_AREA.x - DEFAULT_TILE_SIZE*2, DEFAULT_TILE_SIZE);
	public static final Rectangle ALPHA_CHOOSER_AREA = new Rectangle(DEFAULT_TILE_SIZE + 15, 2, 120, 15);
	public static final Rectangle FRAME_BOUNDARY = new Rectangle(0,0,FRAME_DIMEN.width,FRAME_DIMEN.height);
